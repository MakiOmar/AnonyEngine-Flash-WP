...
define( 'XXX_NOTIFIER_PLUGIN_NAME', 'AnonyEngine Flash WP' ); // The plugin name
define( 'XXX_NOTIFIER_PLUGIN_SHORT_NAME', 'Flash WP' ); // The plugin short name, only if needed to make the menu item fit. Remove this if not needed
define( 'XXX_NOTIFIER_PLUGIN_FOLDER_NAME', 'anony-flash-wp' ); // The plugin folder name
define( 'XXX_NOTIFIER_PLUGIN_FILE_NAME', 'anony-flash-wp.php' ); // The plugin file name
define( 'XXX_NOTIFIER_PLUGIN_XML_FILE', 'https://github.com/MakiOmar/AnonyEngine-Flash-WP/blob/master/notifier.xml' ); // The remote notifier XML file containing the latest version of the plugin and changelog
